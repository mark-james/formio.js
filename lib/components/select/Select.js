  ...
  _createClass(SelectComponent, [{
    ...
    value: function loadItems(url, search, headers, options, method, body) {
      ...
      body = JSON.parse(this.interpolate(JSON.stringify(body), {
        data: this.data, formioOptions: _formio2.default.getOptions(), rootData: this.root.data, parentData: parentData, formioBase: _formio2.default.getBaseUrl(), formData: _formio2.default.getAllFormData()
      }));
