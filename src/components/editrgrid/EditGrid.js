...
export class EditGridComponent extends FormioComponents {
  ...
  saveRow(rowIndex) {
    ...
    this.removeRowComponents(rowIndex);
    // For Some Reason dataValue is readOnly
    let tempDV = _lodash2.default.cloneDeep(this.dataValue);
    tempDV[rowIndex] = this.editRows[rowIndex].data;
    this.dataValue = tempDV;
